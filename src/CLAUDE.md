...
- **Characters:** Character creation, management, and sheet handling
...
- **tavern-trashers:** Main Angular app using PrimeNG components and Keycloak authentication
- **tavern-trashers-web:** Secondary Angular app using NgRx state management and OAuth2/OIDC
...
3. Add module registration in main API project
4. Consider integration events for cross-module communication
