...
namespace TavernTrashers.Api.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260402164425_AddOutboxMessageCreatedBy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TavernTrashers.Api.Modules.Users.Domain.Permissions.Permission", b =>
                {
            ...
            modelBuilder.Entity("TavernTrashers.Api.Modules.Users.Domain.Permissions.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("TavernTrashers.Api.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("TavernTrashers.Api.Modules.Users.Domain.Permissions.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("TavernTrashers.Api.Modules.Users.Domain.Permissions.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("TavernTrashers.Api.Modules.Users.Domain.Users.User", null)
                        .WithMany()
