...
public sealed record TakeDamageCommand(Guid CharacterId, int Amount) : ICommand<HpTrackerResponse>;
...
internal sealed class TakeDamageCommandHandler(ICharacterRepository characterRepository)
	: ICommandHandler<TakeDamageCommand, HpTrackerResponse>
{
	public async Task<Result<HpTrackerResponse>> Handle(TakeDamageCommand command, CancellationToken cancellationToken)
	{
